    ...
    Applications.forEach((app,index) => {
      ...
      appCard.addEventListener("click", function () {
        ...
        menuIcon.addEventListener("click", function (e) {
            e.stopPropagation();
            document.querySelectorAll(".WithdrawArchive").forEach((menu) =>
           ...
           //////////////////////////////////////////////////////////////////
            ...
            radioButtons.forEach((radio) => {
                radio.addEventListener("change", function () {
                    let errorMessage = document.querySelector(`#dialog-${app.id} .error-message`);
                      if (errorMessage) {
                        errorMessage.remove();
                      }
                 });
          ...
          textarea.addEventListener("input", function () {
            let textareaError = document.querySelector(`#dialog-${app.id} .textarea-error`);
               if (textareaError) {
         ...
         withdrawButton.addEventListener("click", function () {
          ...
          if (textarea.value.trim() === '') {
             if (!textareaError) {
                ...
                textareaErrorDiv.className = 'textarea-error text-danger text fw-semibold';
                textareaErrorDiv.textContent = 'You have to type additional comments';
               textarea.style.border = "1px solid red";
               document.querySelector(`#textareaContainer`).appendChild(textareaErrorDiv);
              }
           return;
           }
